...
const CATALOGUES: Array[String] = [
	...
	"factions", "functions", "dialogue", "traits", "histoires", "souhaits", "royaumes_evenements", "name_cultures", "village_buildings", "quest_templates", "plants", "governments", "guilds", "shop_types", "species", "talents", "grilles", "serments", "gaz",
]
...
const CONFIGS: Array[String] = ["combat_rules", "tile_contents", "wuxing", "palette_materiaux", "loot_rules", "rare_epithets", "reading_failures", "astrologie", "calendrier", "villes", "blasons", "material_categories", "minerais_par_etage", "material_families", "camp", "noise_layers", "planete", "absurd_laws_pool", "styles", "creation", "apparence", "poses", "classes_meres", "gaz_regles", "sous_sol", "thermique", "support", "sonore", "odeur", "cadavres", "rumeur", "controles", "maladies", "drogues", "mutations", "lieux", "climat", "matiere", "voyage", "corps", "ecologie"]
