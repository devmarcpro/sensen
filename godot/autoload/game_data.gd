...
const CATALOGUES: Array[String] = [
	...
	"functions", "dialogue", "name_cultures", "village_buildings", "quest_templates", "plants", "governments", "guilds", "shop_types", "species", "talents", "serments",
]
...
const CONFIGS: Array[String] = ["combat_rules", "tile_contents", "wuxing", "palette_materiaux", "loot_rules", "rare_epithets", "reading_failures", "astrologie", "material_categories", "minerais_par_etage", "material_families", "camp", "noise_layers", "planete", "absurd_laws_pool", "styles", "creation", "apparence", "poses", "classes_meres"]
