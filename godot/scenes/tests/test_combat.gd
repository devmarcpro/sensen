...
func _ready() -> void:
	...
	_lancer("test_rumeur_donjon_corrompu")
	_lancer("test_cite_de_rouille")
	_lancer("test_soupcon")
	_lancer("test_fruitiers_hauts")
	...
	_lancer("test_camp_de_deserteurs")
