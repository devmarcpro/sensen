...
func test_village() -> void:
	...
	verifier(GameData.catalogues.name_cultures.size() == 29 and GameData.catalogues.dialogue.size() >= 31 and GameData.catalogues.functions.size() >= 6, "29 cultures, au moins 31 répliques (%d), les fonctions" % GameData.catalogues.dialogue.size())
