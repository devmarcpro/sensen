...
func _dessiner() -> void:
	...
	var couleurs_lieux := {"ruine": Color(0.7, 0.66, 0.6), "donjon_batiment": Color(0.85, 0.3, 0.3), "hameau": Color(0.95, 0.8, 0.45), "camp": Color(0.9, 0.5, 0.2), "sanctuaire": Color(0.6, 0.8, 1.0), "taniere": Color(0.5, 0.32, 0.18), "champ_de_bataille": Color(0.6, 0.1, 0.1)}
