...
- **F à K — les axes de simulation ajoutés le 2026-09-05** ([[Simulation de vie et de monde]]) : **F** la chronique (la mémoire du monde : les faits datés, la pré-histoire avant l'an 1 020, un écran pour les lire), **G** la vie intérieure des PNJ et **H** les liens entre PNJ — tous deux **dans C**, qu'ils précisent —, **I** le corps qui garde ses cicatrices, **J** les chaînes de production et leur débit, **K** la géopolitique vivante — **dans D**. F passe avant tout le reste : il est peu cher, sans risque, et chaque axe suivant y écrit au lieu d'ajouter son propre affichage.
...
- **Voir aussi** : [[À juger — parcours de jeu]], [[Prompt de la boucle]], [[Astrologie — cycle sexagésimal]], [[Simulation de vie et de monde]]
