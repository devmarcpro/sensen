...
> [!success] Mis à jour le 2026-08-31 — le callout de 9.C est dépassé par le contenu
> Le « 3 gabarits » n'en est plus là : **14 gabarits** vivent dans `quest_templates/` (chasse, prime, donjon, livraison, négoce, purge, reconnaissance, traque, banquet, chantier, commande d'artisan, élixirs, enchantement, arcanes) — un par guilde ou presque. Et « les 12 guildes, les halls, les taxes hebdomadaires attendent l'étape 10 » est périmé : les **12 guildes** sont en données (`guilds/`), les **halls** se prennent et se démontent (`territoire.halls`), la **taxe de guilde** est prélevée au passage hebdomadaire (`royaume.taxe_guilde × rang`) — codés à l'étape 10 (callouts d'Économie et de Familles). Reste l'étiquette « arcanes » du gabarit des mages : le domaine Arcane est supprimé (2026-08-31), le renommage est la question déjà posée au designer (point 28).
