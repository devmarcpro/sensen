...
> **Corrigé des deux côtés** : chaque classe reçoit le kit de son style (arme, bouclier ou arc, armure de cuir, torche) et son râtelier *(2026-09-04 : et un carquois quand l'arme est un projectile — trois kits de tir n'en avaient pas et ne pouvaient pas tirer ; voir Décision — Projectiles)* ; et une main vide frappe désormais avec la fonctionnalité `mains_nues` — `1d3` contondant, portée 1, dureté 1 — qui existait partout sauf là où il fallait.
