...
> Les points voxel de D.2 (chunks cubiques 16³ indexés (x,y,z), octrees de subdivision, import .vox) sont retirés — archivés dans le GDD source. Leurs remplaçants : [[Proposition — Structure de données de la grille]] (à valider) et le pipeline de sprites de [[Squelette modulaire et points d'attache]].
...
- **Alimente** : [[Simulation à ticks]], [[EventBus]], [[Sauvegarde]], [[Réseau]], [[Proposition — Structure de données de la grille]]
