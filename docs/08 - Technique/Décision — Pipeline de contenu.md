...
- **Le contenu du coffre `docs/09 - Contenu/` se transcrit tel quel** : chaque ligne des catalogues (153 matériaux, 48+ modules, 34 créatures…) devient un fichier, sans interprétation.
