...
- **Alimente** : [[Structure compétences-modules-slots]], [[Familles de capacités de la grille]], [[Statuts]]
- **Voir aussi** : [[Grimoires et manuels]], [[Mana]], [[Application des stats de matériau]], [[Catalogue matériaux — Météorologiques]], [[Ouvert — Modules du domaine Métal]], [[Wu Xing — cycles et vecteurs]]
