...
> [!success] Mis à jour le 2026-08-31 — `respiration_aquatique` est branché (le « attend » ci-dessus est périmé)
> La jauge de souffle existe (Eau et liquides : `souffle`, noyade) et la simulation exempte le porteur du tag `respiration_aquatique` de toute perte de souffle sous l'eau. Balayage du coffre : la note n'avait pas suivi l'arrivée de la jauge.
