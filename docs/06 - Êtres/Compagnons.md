...
> **Vérifié le 2026-09-04 au soir par la sonde des IA de PNJ** (`sonde_ia_pnj --seulement compagnons`, [[IA des créatures]]) : après douze pas du joueur, les deux compagnons sont à une tuile ; « attends ici » tenu à zéro tuile ; « suis-moi » ramène à une ; contre un bandit, 2 sur 2 entrent dans le combat du maître et le tuent ; « évite » s'écarte à sept tuiles sans un coup ; défensif, il reste à trois tuiles du maître pour une cible à huit, agressif il la poursuit à onze. Le chiffre du robot ci-dessus (trente-deux coups, onze combats) date d'avant le bug d'horloge de [[Boucle de tick]] : rejoué après, cinq combats, vingt-cinq coups des compagnons, zéro mort — les monstres se défendent.
> **2026-09-05, 13 h — le designer : « rajoute sur tous les PNJ une option pour recruter ».** Tout humanoïde vivant, non hostile et sans maître propose *Recruter* (`Simulation.recrutable`). La relation décide du **prix**, pas de la possibilité : au seuil de la fiche (ou en faveur), il suit gratuitement comme avant ; sinon il demande `compagnons.prix_recrutement` pièces d'or (40 — un chiffre de départ), et l'option l'affiche (« Recruter (40 or) »). Sans l'or, le journal le dit. Les places d'escorte s'appliquent toujours.
