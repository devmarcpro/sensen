---
aliases: ["Ouvert — Lore", "Lore", "Mythologie"]
tags: [ouvert, vision, contenu-à-produire]
domaine: vision
statut: à-trancher
etape: 9
---

**Ce qui reste ouvert par nature ([[Décisions fondatrices]]) :** *Lore — noms propres, textes d'ambiance, mythologie — à écrire au fil du contenu.*

**Ce qui est déjà cadré et contraint l'écriture :**
...
**Contrainte de production ([[Localisation]]) :** tout texte d'ambiance doit être une clé localisée en **4 langues** (fr, en, ja, zh), sans concaténation.

## Liens
- **Dépend de** : [[Identité visuelle chinoise]], [[Wu Xing — cycles et vecteurs]]
- **Alimente** : [[Dialogue PNJ]], [[Cultures de nommage]]
- **Voir aussi** : [[Génération de noms]], [[Astrologie — cycle sexagésimal]], [[Localisation]], [[Décisions fondatrices]]
