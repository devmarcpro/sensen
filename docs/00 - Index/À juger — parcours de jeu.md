...
- **Le rendement des classes va de 1 à 16** (mesuré le 2026-09-02, après la refonte des portées). En PV par tick, sur le mannequin du banc : **Le Sabre** rend 10 PV/tick (Projection : 81 PV en 5 ticks), **Le Porteur** 6,4 — ils frappent au contact, où rien ne dilue et rien ne s'atténue. À l'autre bout, **La Balance** rend 0,14 (Étincelle : 1 PV en 7 ticks), **Le Fossoyeur** 0,1 (Banquise : 2 PV en 20 ticks) et **Le Passeur** 0,19 (Flamme : 3 PV en 16 ticks). L'écart n'est pas un bug : le contact ne paie ni portée, ni dilution, ni atténuation, et frappe une seule cible à pleine puissance. Mais il est **trop grand pour un départ de partie** — un Fossoyeur débutant met vingt ticks à retirer deux points de vie. Trois leviers, au choix du designer : relever le plancher de dilution (0,25 aujourd'hui), adoucir l'atténuation par la distance (coef 0,06), ou donner aux classes lointaines des noyaux plus gros au départ — c'est la voie que je préfère, parce qu'elle garde la règle et corrige le contenu. — [[Classes]]
