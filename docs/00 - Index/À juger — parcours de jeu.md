...
2. **Les vingt objets « de fortune »** (`proto_épée`, `proto_arc`, `proto_masse`, casques et cuirasses de cuir, outils en fer…) : ce sont les pièces du prototype, une matière fixe, sans composants ni recette. Hors des tests et d'une vieille recette de seau, rien ne les fabrique ni ne les fait tomber. Pour les sprites, ce sont les mêmes silhouettes que leurs bases assemblées ; pour le jeu, à retirer ou à garder comme butin de fortune — c'est une décision de contenu.
