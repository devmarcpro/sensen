...
> **Ajout du designer (2026-08-30, 22 h 15)** : 21. **Vérifier que le loot soit vraiment aléatoire** — on ne trouve pas « une simple épée » mais une épée au manche en chêne et à la tête en cuivre, de qualité 1,4, etc. : les objets trouvés doivent être des assemblages de composants et de matériaux tirés, avec leur qualité.
