...
> **Ajout du designer (2026-08-31, 0 h 55)** : 24. **Compiler un exécutable et le publier dans les Releases du dépôt, en alpha** — export Windows (Godot 4.6.3, gabarits d'export, `export_presets.cfg`), archive zip, release GitHub pré-version.
