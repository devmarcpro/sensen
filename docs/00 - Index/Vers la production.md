...
> **Ajout du designer (2026-08-30, 20 h 10)** : 17. **Fait (2026-08-30, 20 h 30)** — section « En images » du README, six captures dans `captures/` (écran principal, camp, carte, donjon, combat, composeur). **Bug attrapé en les prenant** : une partie a démarré **dans la mer** (cellule entière sous l'eau, h = 8, souffle 0/310) — `Surface.terre_a` sondait la cellule avec des offsets figés sur 128 (64, 96…) qui tombaient dans la cellule voisine depuis le passage à 64 × 64 ; les sondes suivent maintenant `taille_cellule`. **Rajouter dans le README des captures d'écran du jeu** — écran principal, camp, carte du monde, donjon, combat, composeur ; images dans le dépôt, prises par `capture.tscn`, à rafraîchir quand l'écran change.
...
> **Ajout du designer (2026-08-30, 21 h 05)** : 19. **Minimap** — elle ne représente que la cellule où est le joueur ; deux fois plus petite ; en haut à droite ; compas et Wu Xing en dessous.
> **Ajout du designer (2026-08-30, 21 h 05)** : 20. **Chaque nouvelle partie commence à 8 h du matin** ; **retirer la jauge Wu Xing sous le personnage**.
