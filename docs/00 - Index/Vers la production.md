...
> **Ajout du designer (2026-08-30, 15 h 05)** : 9. Le composeur en **glisser-déposer** : une rangée de **slots** (boutons **+ / −** pour en ajouter ou en retirer), on **glisse** un module du catalogue dans un slot (ou on l'en sort), chaque module a son **icône** (dessinée par code, aucun asset : un glyphe par type de module, teinté par son élément), le joueur **nomme** son sort (champ texte). Le clavier reste possible (Entrée / Suppr) ; l'aperçu visuel et le détail restent en dessous.
