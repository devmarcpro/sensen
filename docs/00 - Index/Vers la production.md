...
> **Ajout du designer (2026-08-31, 14 h 10)** : 36. **Remplacer les escaliers des donjons par de vrais escaliers** — marcher dessus change d'étage automatiquement (plus de touche E pour descendre/remonter). — [[Génération de donjon]], [[Écrans d'interface]]
> **Ajout du designer (2026-08-31, 14 h 05)** : 34. **Commencer une nouvelle partie directement dans un donjon** — une option au démarrage. 35. **La hotbar dans l'inventaire et l'écran de capacités**, avec glisser-déposer vers la hotbar, tout simplement. — [[Écrans d'interface]]
