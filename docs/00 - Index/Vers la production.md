...
> **Ajout du designer (2026-08-30, 16 h 40)** : 13. Après la liste « additif », **essayer en profondeur le dungeon crawling** — descendre plusieurs étages en jouant réellement (fuzz guidé, captures à chaque étape), et **analyser tous les aspects**, visuels (lisibilité des salles, du brouillard, des blocs, des êtres, du HUD en donjon) comme mécaniques (rythme des combats, loot, escaliers, coffres, murs à creuser, corruption, retour au camp) ; rendre un **rapport** avec ce qui marche, ce qui casse, ce qui manque, dans Vers la production et À juger.
