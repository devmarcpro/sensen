...
> **Ajouts du designer (2026-08-30, 16 h 15) — « j'aime ce que tu proposes dans pur affichage et additif »** : 10. **L'XP gagnée affichée à chaque action** (flottant au-dessus du joueur + journal : élément, compétence, type). **Codé le 2026-08-30** ([[XP de combat]]). 11. Pur affichage, dans l'ordre : ~~timeline des prochains à agir~~ (codée le 2026-08-30) ; états sur les portraits avec durée ; bulle de dégâts min–max et résistances au survol ; ligne de vue dessinée à la visée ; prévisualisation d'atterrissage des poussées ; critiques en gros. 12. Additif : dégâts de poussée ; condition « cible alignée » ; pièges invisibles ; marques et consommation ; érosion ; ~~tacle~~ (refusé par le designer, 16 h 20) ; fiches d'invocations qui agissent ; ~~boss à mécaniques~~ (refusé, 16 h 22) ; arènes-puzzle. **Hors design, non retenus** : PA/PM, initiative, relances, cases de départ.
