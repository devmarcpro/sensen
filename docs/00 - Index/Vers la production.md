...
> Le HUD affiche les deux éléments dominants du lieu (« lieu : Feu 34 % · Eau 28 % ») ; en donjon, la tuile du personnage n'est plus voilée — deux points d'À juger réglés par la lisibilité.
