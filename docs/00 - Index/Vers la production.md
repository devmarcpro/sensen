...
> **Ajout du designer (2026-08-31, 14 h 30)** : 37. **De nouveaux types d'ennemis avec d'autres rigs** — des silhouettes variées (quadrupède, volant, amorphe...) dessinées par code, pas seulement des humanoïdes. — [[Squelette modulaire et points d'attache]], [[Créatures]]
