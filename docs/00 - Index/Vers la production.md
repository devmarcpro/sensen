...
> **Ajout du designer (2026-08-30, 23 h 55)** : 23. **En cours (2026-08-31, 0 h 20)** — fenêtres à 94 % de l'écran et inventaire visuel faits ([[Écrans d'interface]]) ; l'atelier suit. **Refonte de l'inventaire et de l'écran de craft** — plus visuels (icônes des objets, aperçu de l'avatar avec ses slots d'équipement, Wu Xing…), plus beaux ; **les fenêtres prennent plus de l'écran** en général.
