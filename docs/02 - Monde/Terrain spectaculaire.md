...
> Les chiffres voxel (« 200-400 blocs », « 30-80 blocs ») et le bruit 3D de cavernes sont retirés — archivés dans le GDD source. La quantification du relief sur 21 niveaux : [[Proposition — Altitude sur 21 niveaux]] (à valider).
...
**Quantification ([[Proposition — Altitude sur 21 niveaux]]) :** la hauteur de tuile 0-20 dérive du champ continu par **relief relatif au voisinage** — une cellule de montagne utilise toute l'amplitude avec de nombreux Δ infranchissables ; l'altitude absolue devient un label macro de la cellule (classe mer → haute montagne).
...
## Liens
- **Dépend de** : [[Unification macro-micro]], [[Catalogue des couches de bruit]], [[Proposition — Altitude sur 21 niveaux]]
- **Alimente** : [[Hauteur de terrain ±10]], [[Eau et liquides]]
- **Voir aussi** : [[Génération procédurale — performance]], [[Zones de coup par dénivelé]], [[Proposition — Minerais et strates après le pivot]]
