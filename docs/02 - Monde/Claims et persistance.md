...
> [!success] Décidé et codé le 2026-08-28 — le camp de base de l'étape 7 (`SimLieux.charger_camp`, appelé par `Simulation.charger_camp`) *(citation corrigée le 2026-09-07 : il n'y a pas de `systems/worldgen/camp.gd` — le camp se charge depuis `systems/simulation/sim_lieux.gd`)*
