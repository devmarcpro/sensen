...
> [!success] Précisé le 2026-08-31 — rectangulaire et ceinturé d'océan (designer, point 49)
> Deux règles de forme s'ajoutent, sur demande du designer. Le monde **n'est plus carré** : `monde_ratio` (0,50 par défaut) donne une carte **deux fois plus large que haute**, la proportion d'une mappemonde — plaques, points chauds, calibrage du seuil et cellule de départ suivent la nouvelle hauteur, et le réglage est offert à la création. Et le monde est **entouré d'eau** : sur une marge de 10 % du plus petit côté, la continentalité s'effondre quelles que soient les plaques (`tectonique.ocean_bord`), donc **aucune terre ne touche le bord de la carte** — au-delà, c'est l'océan, ce qui borne le monde sans mur invisible.
>
> L'aperçu occupe désormais **presque toute la fenêtre** (le panneau s'élargit à l'écran Monde) et se lit en détail : mers nuancées par la profondeur, frange littorale sableuse, biomes à leur teinte, hautes terres blanchies, et la cellule de départ marquée d'une croix cerclée.

> [!success] Codé le 2026-08-31 — le monde se voit et se règle avant d'y entrer (designer, point 49)
> La décision de cette note était déjà dans le moteur — plaques tectoniques, continents, îles, océan bordant le monde — mais **le joueur ne la voyait nulle part** : l'écran Monde ne montrait qu'une graine. Il affiche désormais un **aperçu du monde entier**, échantillonné sur toute la carte (une image de 128 × 128 pour 1024 × 1024 cellules, une passe par régénération), avec ses mers, ses côtes, ses reliefs et la croix de la cellule de départ.
>
