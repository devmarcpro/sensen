...
> [!bug] Corrigé le 2026-09-01 — « je drop quasiment que des armures en os massif » (designer)
> **Mesuré** : sur 200 casques tirés à l'étage 2, **102 en os massif** — 51 % — les 98 autres répartis entre seize métaux, soit 5 % chacun. Le loot paraissait monomatériau parce qu'il l'était à moitié.
> **La cause** : le composant tirait d'abord une **recette** au hasard parmi les siennes, puis un matériau dans la famille de cette recette. La `plaque` a trois recettes — écaille (aucun matériau au catalogue, donc toujours sautée), os massif (**un** matériau) et lingot de métal (**vingt-trois**). Une famille d'un seul matériau avait donc autant de chances qu'une famille de vingt-trois : pile ou face entre « l'os » et « un métal quelconque ».
