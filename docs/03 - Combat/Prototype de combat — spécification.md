...
> Restent : 9 (projectiles, tir refusé si un allié masque, munitions), 10 (statuts, fuite IA par Discrétion, embuscade), 11 (interruption de la jauge des élites par les contrôles — la fonction `interrompre` existe), 12 (écran de fin, XP des trois pistes, polissage).
