...
**Commandes :** clic — se déplacer / frapper · Maj+clic — attaque lourde · G — garde · Espace — attendre · 1-7 — changer d'arme · F1-F3 puis clic — lancer une capacité (Échap annule) · Tab — arène suivante (puis le donjon généré) · E — descendre (escalier doré) / remonter et sortir (escalier vert) · clic sur un mur adjacent — creuser (10 ticks) · brouillard de guerre : on découvre l'étage avec sa vision (Perception, ligne de vue), les êtres hors de vue ne sont pas affichés · le donjon : une cellule de 128×128, 14-24 salles de tailles variées reliées en réseau maillé de couloirs sinueux, façon Elin / ToME · R — ramasser · ⇧chiffre — équiper depuis le sac · T — sertir une gemme · L — lire un livre · C — feuille de personnage · au lancement : création (R race, C classe, ↑↓ +− points, ←→ année, Entrée) · F5 — recharger les données · molette — zoom · clic milieu — déplacer la vue.
