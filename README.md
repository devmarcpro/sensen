...
| ![Composeur](captures/composeur.png) **Le composeur de sorts** — formes, noyaux, modificateurs en glisser-déposer, Wu Xing du sort et aperçu | ![Création du personnage](captures/creation.png) **La création du personnage** — nom, race, classe, année, stats ; l'apparence (tête, yeux, nez, bouche, cheveux, carrure, teint) et sept sorts recommandés à cocher |
